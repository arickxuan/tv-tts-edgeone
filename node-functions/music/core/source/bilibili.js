...
async function getCid(bvid, aid) {
    ...
    const cidRes = (await axios.default.get("https://api.bilibili.com/x/web-interface/view?%s", {
        headers: headers,
        params: params,
    })).data;
    return cidRes;
...
async function getCookie() {
    if (!cookie) {
        cookie = (await axios.default.get("https://api.bilibili.com/x/frontend/finger/spi", {
            headers: {
...
async function searchBase(keyword, page, searchType) {
    ...
    const res = (await axios.default.get("https://api.bilibili.com/x/web-interface/search/type", {
...
async function getFavoriteList(id) {
    ...
    while (true) {
        try {
            const { data: { data: { medias, has_more }, }, } = await axios.default.get("https://api.bilibili.com/x/v3/fav/resource/list", {
                params: {
                    media_id: id,
                    platform: "web",
                    ps: pageSize,
...
async function getBiliTicket(csrf) {
    ...
    try {
        const response = await axios.default.post(url, null, {
            params: {
                key_id: 'ec02',
                hexsign: hexSign,
                'context[ts]': ts,
...
async function getWWebId(id) {
    ...
    const html = (await axios.default.get("https://space.bilibili.com/" + id, {
        headers: {
            "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 Safari/537.36 Edg/89.0.774.63",
        }
    })).data;
...
async function getArtistWorks(artistItem, page, type) {
    ...
    const res = (await axios.default.get("https://api.bilibili.com/x/space/wbi/arc/search", {
...
async function getMediaSource(musicItem, quality) {
    ...
    const res = (await axios.default.get("https://api.bilibili.com/x/player/playurl", {
        headers: headers,
...
async function getTopLists() {
    ...
    const weeklyRes = await axios.default.get("https://api.bilibili.com/x/web-interface/popular/series/list", {
        headers: {
...
async function getTopListDetail(topListItem) {
    const res = await axios.default.get(`https://api.bilibili.com/x/web-interface/${topListItem.id}`, {
...
async function getMusicComments(musicItem) {
    ...
    const w_rid = await getRid(params);
    const res = (await (axios.default.get("https://api.bilibili.com/x/v2/reply/wbi/main", {
        params: Object.assign(Object.assign({}, params), { w_rid })
    }))).data;
